...
public class SettingsWrapper {
    ...
    public double getDouble(String path, SettingsSection section){
        if (section != null) return ((Double) section.sectionMap.get(path));
        return ((Double) settingsMap.get(path));
    }

    public void setDouble(String path, double value, SettingsSection section) {
        if (section != null) {
            section.sectionMap.remove(path);
            section.sectionMap.put(path, value);
            section.save();
    ...
    public float getFloat(String path, SettingsSection section){
        if (section != null) return ((Double) section.sectionMap.get(path)).floatValue();
        return ((Double) settingsMap.get(path)).floatValue();
    }

    public void setFloat(String path, float value, SettingsSection section) {
        if (section != null) {
            section.sectionMap.remove(path);
            section.sectionMap.put(path, value);
            section.save();
