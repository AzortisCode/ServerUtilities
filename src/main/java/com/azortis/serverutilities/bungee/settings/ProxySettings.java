...
import com.azortis.serverutilities.bungee.settings.servercommands.ServerCommandSettings;
...
public class ProxySettings implements Serializable {
    ...
    public ServerCommandSettings getServerCommandSettings() {
        return serverCommandSettings;
    }
